...
WeeklyReport weeklyReportFromJson(String str) => WeeklyReport.fromJson(json.decode(str));
...
class WeeklyReport {
  ...
  factory WeeklyReport.fromJson(Map<String, dynamic> json) => WeeklyReport(
    ...
    reportEvidences: List<ReportEvidence>.from(json["reportEvidences"].map((x) => ReportEvidence.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "week": week.toJson(),
    "reportEvidences": List<dynamic>.from(reportEvidences.map((x) => x.toJson())),
  };
}
